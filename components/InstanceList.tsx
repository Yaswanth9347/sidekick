...
const InstanceList: React.FC = () => {
  const { instances, setInstances, selectInstance, settings, user } = useGlobal();
                  ...
                  <tr key={inst.id} className="hover:bg-white/[0.02] transition-colors group">
                    <td className={rowPadding}>
                      <div className="flex items-center gap-3">
                        <div className={`${iconSize} rounded-lg flex items-center justify-center text-white ${inst.tier === Tier.ENTERPRISE ? 'bg-gradient-to-br from-purple-500 to-indigo-600' :
                    ...
                    <td className={rowPadding}>
                      <span className={`text-[10px] uppercase font-bold px-2 py-0.5 rounded border ${inst.tier === Tier.ENTERPRISE ? 'border-purple-500/30 text-purple-400 bg-purple-500/10' :
